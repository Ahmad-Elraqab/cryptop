...
class BacktestHeaderForm extends StatefulWidget {
  const BacktestHeaderForm({Key? key, this.smartTrade}) : super(key: key);

  final BacktestModel? smartTrade;

  @override
  State<BacktestHeaderForm> createState() => _BacktestHeaderFormState();
}
...
class _BacktestHeaderFormState extends State<BacktestHeaderForm> {
  ...
  Future<void> onSubmit() async {
    ...
    if (val == false) {
      ...
      final data = await context.read(createBacktest(form).future);
                  ...
                  for (int i = 0; i < textField.length; i++)
                    i == 12 || i == 11
                        ? DateTimePicker(
                            ...
                            timeLabelText: 'start date',
                            timeHintText: 'start date',
